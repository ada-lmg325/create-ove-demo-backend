import { FilterOptions, FilterState } from "@/interfaces/filter";
...
export const Filters = ({
  ...
  const [currFilterState, setCurrFilterState] =
      ...
      <>
        ...
        <div className="flex flex-wrap">
          ...
          <SliderFilter
            ...
            currVals={[currFilterState.min_length, currFilterState.max_length]}
            setCurrVals={(val: number[]) =>
              setCurrFilterState((currFilterState) => ({
                ...currFilterState,
                min_length: val[0],
